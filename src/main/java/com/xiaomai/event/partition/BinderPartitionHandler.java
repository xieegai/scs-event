 ...
 */
public class BinderPartitionHandler {
	...
	/**
	 * Construct a {@code BinderPartitionHandler}.
	 *
	 ...
	 */
	public BinderPartitionHandler(String destination,
	...
	public int determinePartition(Message<?> message) {
		...
		return Math.abs(partition % PartitionRouteUtil.getPartitionCount(destination));
	}
