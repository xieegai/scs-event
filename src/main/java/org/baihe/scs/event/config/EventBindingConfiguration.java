...
import org.baihe.scs.event.config.adapter.EventHandlerAnnotationBeanPostProcessor;
import org.baihe.scs.event.config.adapter.EventHandlerMethodFactory;
...
public class EventBindingConfiguration {
    ...
    @Bean
    public EventChannelBindingTargetFactory channelFactory(EventBindingServiceProperties eventBindingServiceProperties,
                                                           CompositeMessageConverterFactory compositeMessageConverterFactory) {
        return new EventChannelBindingTargetFactory(eventBindingServiceProperties, compositeMessageConverterFactory);
    }
